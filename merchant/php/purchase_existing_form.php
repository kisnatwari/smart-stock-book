	...
	<script>
		...
		$(document).ready(function(){
			if(sessionStorage.getItem("purchase_existing_id") != null){
					$("select#product-name").val(sessionStorage.getItem("purchase_existing_id"));
					get_product_data(sessionStorage.getItem("purchase_existing_id"));
					sessionStorage.removeItem("purchase_existing_id");
			}
		})
