...
<div class="animate__animated animate__fadeIn animate_faster" style="width: fit-content;">
	<div class="d-flex justify-content-end">
		<button class="btn btn-sm border bor-2 text-2 my-3 shadow-none purchase-existing-btn" style="border-radius: 20px;" onclick="switch_purchase_form('purchase_existing')"><b> <i class="mdi mdi-update"></i> Update Existing Product</b></button>
	</div>
		...
		<div class="row purchase-container bg-white p-3 sh rounded" style="max-width: 960px;">
			<div class="col-md-4 product-img-section">
				<div class="img-con mx-auto rounded-circle sh-lg border d-flex overflow-hidden justify-content-center align-items-center position-relative" style="width: 140px; height: 140px;">
					...
					<input type="file" accept="image/*" name="product-img" class="position-absolute w-100 h-100 cp product-img" onchange="change_img(this)" style="opacity: 0; top: 0; left: 0;">
				</div>
			</div>
			<div class="col-md-8">
			...
			<div class="col-sm-6 col-lg-4">
				<div class="form-group my-2">
					...
					<input type="number" id="unit-price" class="form-control shadow-none border" name="unit-price">
				</div>
			</div>
			<div class="col-sm-6 col-lg-4">
				<div class="form-group my-2">
	...
	<script>
		//checking session of existing purchase
		$(document).ready(function(){
			if(sessionStorage.getItem("purchase_existing_id") != null){
				$(".purchase-existing-btn").click();
				return;
			}
		})
		...
		function change_img(event){
			...
			if((file.type == "") || (file.type.split("/")[0] != "image")){
		    	...
		    	$(".img-caption").html("<span class='text-4 animate__animated animate__fadeInUp'><b>Invalid <br> Image <br> Format</b></span>");
		    	event.value = null;
		    	setTimeout(() =>{
		    		if(!img_set)
